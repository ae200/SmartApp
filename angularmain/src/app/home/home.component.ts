...
this.req.unsubscribe();
  ...
  //     this.router.navigate(['./actionmovies']);
  //   }
  //    if (!image.prevented) {
  //     event.preventDefault();
  //     this.router.navigate(['./adventuremovies']);
  //   }
  //   if (!image.prevented) {
  //     event.preventDefault();
  //     this.router.navigate(['./comedymovies']);
  //   }
  //   if (!image.prevented) {
  //     event.preventDefault();
  //     this.router.navigate(['./historicalmovies']);
  //   }
  //   if (!image.prevented) {
  //     event.preventDefault();
  //     this.router.navigate(['./fictionmovies']);
  //   }
  //   if (!image.prevented) {
  //     event.preventDefault();
  //     this.router.navigate(['./dramamovies']);
  //   }
  // }
getEmbedUrl(item) {

...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(BsDropdownContainerComponent, [{
  ...
  `
    ...
    }], function () { return [{ type: BsDropdownState }, { type: ChangeDetectorRef }, { type: Renderer2 }, { type: ElementRef }, { type: AnimationBuilder }]; }, { constructor: [], _state: [], cd: [], _renderer: [], _element: [], isOpen: [], _factoryDropDownAnimation: [], _subscription: [], direction: [], _contains: [], ngOnDestroy: [] });
if (false) {
    /** @type {?} */

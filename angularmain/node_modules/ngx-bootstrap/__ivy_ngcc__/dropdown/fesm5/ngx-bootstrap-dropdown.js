...
const _c0 = [2, "display", "block", "position", "absolute", "z-index", "1040"];
const _c1 = ["*"];
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(BsDropdownConfig, [{
        type: Injectable
    }], function () { return []; }, { autoClose: [], insideClick: [], isAnimated: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(BsDropdownContainerComponent, [{
    ...
    }], function () { return [{ type: BsDropdownState }, { type: ChangeDetectorRef }, { type: Renderer2 }, { type: ElementRef }, { type: AnimationBuilder }]; }, { _state: [], cd: [], _renderer: [], _element: [], isOpen: [], _factoryDropDownAnimation: [], _subscription: [], direction: [], _contains: [], ngOnDestroy: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(BsDropdownDirective, [{
        ...
        args: [{
    ...
    }], function () { return [{ type: ElementRef }, { type: Renderer2 }, { type: ViewContainerRef }, { type: ComponentLoaderFactory }, { type: BsDropdownState }, { type: BsDropdownConfig }, { type: AnimationBuilder }]; }, { _elementRef: [], _renderer: [], _viewContainerRef: [], _cis: [], _state: [], _config: [], _isInlineOpen: [], _subscriptions: [], _isInited: [], _factoryDropDownAnimation: [], _dropdown: [], onShown: [{
            type: Output
        }], onHidden: [{
            type: Output
        }], isOpenChange: [{
            ...
            type: Input
        }], isOpen: [], isBs4: [], _showInline: [], ngOnInit: [], show: [], hide: [], toggle: [], _contains: [], ngOnDestroy: [], addBs4Polyfills: [], playAnimation: [], addShowClass: [], removeShowClass: [], checkRightAlignment: [], addDropupStyles: [], removeDropupStyles: [], placement: [{
            type: Input
        }], triggers: [{
            type: Input
        }], container: [{

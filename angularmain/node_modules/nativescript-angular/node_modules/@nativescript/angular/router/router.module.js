...
var NativeScriptRouterModule = /** @class */ (function () {
    ...
    NativeScriptRouterModule.forRoot = function (routes, config) {
        return {
            ...
            providers: __spreadArrays(router_1.RouterModule.forRoot(routes, config).providers, NS_ROUTER_PROVIDERS)
        };
    };
    ...
    NativeScriptRouterModule = NativeScriptRouterModule_1 = __decorate([
        core_1.NgModule({
            ...
            exports: __spreadArrays([router_1.RouterModule], ROUTER_DIRECTIVES),

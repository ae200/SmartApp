...
function createEmptyNsOnlyProject(projectName, nsExtension = '') {
    const setup = Object.assign({}, defaultProjectSettings, { projectName, nsExtension });
...
function createEmptySharedProject(projectName, webExtension = '', nsExtension = '.tns') {
    const setup = Object.assign({}, defaultProjectSettings, { projectName, webExtension, nsExtension });
    const additionalFiles = [
        getNsConfig(setup),

...
describe('Angular JSON Config Schematic', () => {
    ...
    it('should insert the prefix option', () => __awaiter(this, void 0, void 0, function* () {
        const prefix = 'custom-prefix';
        const tree = yield schematicRunner.runSchematicAsync('angular-json', Object.assign({}, defaultOptions, { prefix })).toPromise();
        expect(test_1.getFileContent(tree, configPath)).toContain(`"prefix": "${prefix}"`);
    }));
    it('should insert the sourceRoot option', () => __awaiter(this, void 0, void 0, function* () {
        const sourceRoot = 'src';
        const tree = yield schematicRunner.runSchematicAsync('angular-json', Object.assign({}, defaultOptions, { sourceRoot })).toPromise();
        expect(test_1.getFileContent(tree, configPath)).toContain(`"sourceRoot": "${sourceRoot}"`);
    }));
    it('should create files inside path when specified', () => __awaiter(this, void 0, void 0, function* () {
        const projectPath = '/path/to/my/app';
        const appJsonPath = `${projectPath}/angular.json`;
        const options = Object.assign({}, defaultOptions, { path: projectPath });

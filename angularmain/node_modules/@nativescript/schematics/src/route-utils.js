...
function insertImport(source, fileToEdit, symbolName, fileName, quote = '\"', isDefault = false) {
    ...
    if (relevantImports.length > 0) {
        ...
        if (importTextNodes.length === 0) {
            const fallbackPosition = ast_utils_1.findNodes(relevantImports[0], ts.SyntaxKind.CloseBraceToken)[0].getStart() ||
                ast_utils_1.findNodes(relevantImports[0], ts.SyntaxKind.FromKeyword)[0].getStart();
            return ts_utils_1.insertBeforeFirstOccurence(imports, `, ${symbolName}`, fileToEdit, fallbackPosition);
        }
        return new change_1.NoopChange();
    }
    ...
    return ts_utils_1.insertBeforeFirstOccurence(allImports, toInsert, fileToEdit, fallbackPos);
}

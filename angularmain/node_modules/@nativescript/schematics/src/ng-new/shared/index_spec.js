...
describe('Shared Application Schematic', () => {
    ...
    it('should create all files of an application', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should create all sample files when the sample flag is provided', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should generate correct files when different style extension is specified', () => __awaiter(this, void 0, void 0, function* () {

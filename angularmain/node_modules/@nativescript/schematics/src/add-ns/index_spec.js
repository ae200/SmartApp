...
describe('Add {N} schematic', () => {
    ...
    describe('when using the default options', () => {
        ...
        it('should create the tsconfig.tns.json with files and path mappings', () => {
            ...
            const nsTsConfig = JSON.parse(test_1.getFileContent(appTree, nsTsConfigPath));
        ...
        it('should create the tsconfig.spec.json (web) with files', () => {
            ...
            const specTsConfig = JSON.parse(test_1.getFileContent(appTree, specTsConfigPath));
        ...
        it('should modify the base tsconfig.json to include path mappings', () => {
            ...
            const baseTsConfig = JSON.parse(test_1.getFileContent(appTree, baseTsConfigPath));
        ...
        it('should modify tslint.json to include rule for using remapped imports', () => {
            ...
            const tsLintConfig = JSON.parse(test_1.getFileContent(appTree, tsLintConfigPath));

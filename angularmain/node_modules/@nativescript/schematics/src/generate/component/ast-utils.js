...
function addDeclarationToNgModule(tree, options, componentPath, modulePath) {
    ...
    if (options.export) {
        ...
        const exportChanges = ast_utils_1.addExportToModule(src, modulePath, strings_1.classify(`${options.name}Component`), relativePath);
    ...
    if (options.entryComponent) {
        ...
        const entryComponentChanges = ast_utils_1.addEntryComponentToModule(src, modulePath, strings_1.classify(`${options.name}Component`), relativePath);

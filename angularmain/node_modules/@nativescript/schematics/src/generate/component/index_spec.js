...
describe('Component Schematic', () => {
    ...
    describe('when in ns-only project', () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('specifying custom extension', () => {
        describe('in ns only project', () => {
            ...
            it('should respect specified {N} extension', () => __awaiter(this, void 0, void 0, function* () {
            ...
            it('should respect specified style extension', () => __awaiter(this, void 0, void 0, function* () {
                const styleext = 'scss';
        ...
        describe('in ns+web project', () => {
            describe('when a custom web extension is specified', () => {
                ...
                it('should create the files with this extension', () => __awaiter(this, void 0, void 0, function* () {
                    const options = Object.assign({}, componentOptions);
                    appTree = yield schematicRunner.runSchematicAsync('component', options, appTree).toPromise();
                    const componentTemplatePath = getTemplatePath(customExtension);
                    expect(appTree.exists(componentTemplatePath)).toBeTruthy();
                }));
                it('should declare in NgModule', () => __awaiter(this, void 0, void 0, function* () {
                    const options = Object.assign({}, componentOptions);
                    appTree = yield schematicRunner.runSchematicAsync('component', options, appTree).toPromise();
                ...
                it('should respect the module option', () => __awaiter(this, void 0, void 0, function* () {
            ...
            describe('when custom web and {N} extensions are specified', () => {
                ...
                it('should create the files with these extensions', () => __awaiter(this, void 0, void 0, function* () {
                    const options = Object.assign({}, componentOptions);
                    appTree = yield schematicRunner.runSchematicAsync('component', options, appTree).toPromise();

...
describe('Module Schematic', () => {
    ...
    describe('when in ns-only project', () => {
        ...
        it('should respect passed extension', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should not have NativeScriptCommonModule imported if that is specified explicitly', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should not have RouterModule imported in the routing module', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should have NativeScriptRouterModule imported', () => __awaiter(this, void 0, void 0, function* () {
            const options = Object.assign({}, defaultOptions, { routing: true });
            const testTree = yield schematicRunner.runSchematicAsync('module', options, appTree).toPromise();
    ...
    describe('when in ns+web project', () => {
        ...
        describe('executing ns-only schematic', () => {
            ...
            it('should create ns module file', () => __awaiter(this, void 0, void 0, function* () {
            ...
            it('should not create web module file', () => __awaiter(this, void 0, void 0, function* () {
                const options = Object.assign({}, nsOnlyOptions);
                const tree = yield schematicRunner.runSchematicAsync('module', options, appTree).toPromise();
                expect(tree.exists(webModulePath)).toBeFalsy();
            }));
            it('should not create a common file', () => __awaiter(this, void 0, void 0, function* () {
                const options = Object.assign({}, nsOnlyOptions);
                const tree = yield schematicRunner.runSchematicAsync('module', options, appTree).toPromise();
                expect(tree.exists(commonFilePath)).toBeFalsy();
            }));
        ...
        describe('executing web-only schematic', () => {
            ...
            it('should create web module file', () => __awaiter(this, void 0, void 0, function* () {
            ...
            it('should not create ns module file', () => __awaiter(this, void 0, void 0, function* () {
                const options = Object.assign({}, webOnlyOptions);
                const tree = yield schematicRunner.runSchematicAsync('module', options, appTree).toPromise();
                expect(tree.exists(nsModulePath)).toBeFalsy();
            }));
        ...
        describe('executing web+ns schematic', () => {
            ...
            it('should generate both web and ns module files', () => __awaiter(this, void 0, void 0, function* () {
            ...
            it('should create a common file', () => __awaiter(this, void 0, void 0, function* () {
                const options = Object.assign({}, nsWebOptions);
                const tree = yield schematicRunner.runSchematicAsync('module', options, appTree).toPromise();
                expect(tree.exists(commonFilePath)).toBeTruthy();
            }));
            it('should create both routing modules when routing flag is passed', () => __awaiter(this, void 0, void 0, function* () {

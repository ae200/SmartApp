...
describe('Convert relative imports to mapped imports', () => {
    ...
    it('should convert the relative imports in a newly generated file', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should convert the relative imports in a modified file', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should convert the relative imports in a created and then renamed file', () => __awaiter(this, void 0, void 0, function* () {
        let appTree = test_utils_1.createTestProject(projSetup);
    ...
    it('should not modify files that weren\'t modified', () => __awaiter(this, void 0, void 0, function* () {
        let appTree = test_utils_1.createTestProject(projSetup, [{
                path: aboutModulePath,
    ...
    it('should not modify files with extension other than .ts', () => __awaiter(this, void 0, void 0, function* () {
        let appTree = test_utils_1.createTestProject(projSetup);

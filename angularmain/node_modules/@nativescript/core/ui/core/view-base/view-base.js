...
exports.classNameProperty = new properties_1.Property({
    ...
    valueChanged: function (view, oldValue, newValue) {
        ...
        var shouldAddModalRootViewCssClasses = cssClasses.has(system_classes_1.MODAL_ROOT_VIEW_CSS_CLASS);
        var shouldAddRootViewCssClasses = cssClasses.has(system_classes_1.ROOT_VIEW_CSS_CLASS);
        cssClasses.clear();

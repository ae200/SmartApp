...
function updateBackgroundPositions(tabStrip, tabStripItem) {
    ...
    if (!bgView) {
        ...
        var frame = CGRectMake(width * index_1, 0, width, tabStrip.nativeView.frame.size.width);
        ...
        var width = tabStrip.nativeView.frame.size.width / tabStrip.items.length;
        var frame = CGRectMake(width * index_2, 0, width, tabStrip.nativeView.frame.size.width);
        bgView.frame = frame;
    }

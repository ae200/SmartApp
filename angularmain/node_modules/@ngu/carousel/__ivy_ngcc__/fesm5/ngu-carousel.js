...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NguCarouselOutlet, [{
    ...
    }], function () { return [{ type: ViewContainerRef }]; }, { viewContainer: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NguCarousel, [{
        ...
        args: [{
                ...
                type: Inject,
                args: [PLATFORM_ID]
            }] }, { type: ChangeDetectorRef }]; }, { dataSource: [{
            type: Input,
            args: ['dataSource']
        }], dataSource: [], nextBtn: [{
            type: ContentChild,
            ...
            type: Input
        }], trackBy: [], ngOnInit: [], _dataDiffer: [], ngDoCheck: [], arrayChanges: [], _switchDataSource: [], _dataSource: [], _observeRenderChanges: [], _dataSubscription: [], renderNodeChanges: [], _updateItemIndexContext: [], _getNodeDef: [], ngAfterViewInit: [], carousel: [], carouselCssNode: [], listener3: [], ngAfterContentInit: [], _inputValidation: [], type: [], loop: [], RTL: [], interval: [], velocity: [], directionSym: [], point: [], ngOnDestroy: [], _onResizing: [], onResize: [], _touch: [], _touchHandling: [], dexVal: [], _setTouchTransfrom: [], touchTransform: [], _setTransformFromTouch: [], _onWindowScrolling: [], _storeCarouselData: [], deviceWidth: [], carouselWidth: [], deviceType: [], items: [], itemWidth: [], slideItems: [], load: [], speed: [], reset: [], withAnim: [], _carouselPoint: [], pointIndex: [], pointNumbers: [], _carouselPointActiver: [], activePoint: [], moveTo: [], _carouselSize: [], token: [], styleid: [], _carouselScrollOne: [], _carouselScrollTwo: [], itemLength: [], currentSlide: [], _btnBoolean: [], isFirst: [], isLast: [], _transformString: [], _transformStyle: [], _carouselLoadTrigger: [], _generateID: [], _carouselInterval: [], listener4: [], _updateItemIndexContextAni: [], _carouselAnimator: [], _removeAnimations: [], _setStyle: [], _createStyleElem: [], inputs: [{
            type: Input
        }], carouselLoad: [{
            type: Output
        }], onMove: [{

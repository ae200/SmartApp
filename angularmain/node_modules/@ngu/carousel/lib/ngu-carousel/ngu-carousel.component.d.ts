...
export declare class NguCarousel<T> extends NguCarouselStore implements OnInit, AfterContentInit, AfterViewInit, OnDestroy, DoCheck {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<NguCarousel<any>>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NguCarousel<any>, "ngu-carousel", never, { 'dataSource': "dataSource", 'trackBy': "trackBy", 'inputs': "inputs" }, { 'carouselLoad': "carouselLoad", 'onMove': "onMove" }, ["nextBtn", "prevBtn", "_defDirec"]>;
}

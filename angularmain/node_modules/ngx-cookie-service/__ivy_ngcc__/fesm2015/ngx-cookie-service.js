...
CookieService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: CookieService, factory: function (t) { return CookieService.ɵfac(t); }, providedIn: 'root' });;
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CookieService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
                ...
                type: Inject,
                args: [PLATFORM_ID]
            }] }]; }, { constructor: [], document: [], platformId: [], documentIsAccessible: [], check: [], get: [], getAll: [], set: [], delete: [], deleteAll: [], getCookieRegExp: [], safeDecodeURIComponent: [] });

...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgLocaleLocalization, [{
        type: Injectable
                ...
                type: Inject,
                args: [LOCALE_ID]
            }] }]; }, { constructor: [], locale: [], getPluralCategory: [] });
if (false) {
    /**
     * @type {?}
     * @protected
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgForOf, [{
    ...
    }], function () { return [{ type: ViewContainerRef }, { type: TemplateRef }, { type: IterableDiffers }]; }, { constructor: [], _viewContainer: [], _template: [], _differs: [], _ngForOf: [], _ngForOfDirty: [], _differ: [], ngForOf: [{
            type: Input
        }], ngForTrackBy: [{
            type: Input

...
export declare class NgbCarousel implements AfterContentChecked, AfterContentInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NgbCarousel, "ngb-carousel", ["ngbCarousel"], { 'interval': "interval", 'wrap': "wrap", 'keyboard': "keyboard", 'pauseOnHover': "pauseOnHover", 'showNavigationArrows': "showNavigationArrows", 'showNavigationIndicators': "showNavigationIndicators", 'activeId': "activeId" }, { 'slide': "slide" }, ["slides"]>;
}
/**

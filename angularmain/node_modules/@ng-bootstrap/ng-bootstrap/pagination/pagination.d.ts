...
export declare class NgbPagination implements OnChanges {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NgbPagination, "ngb-pagination", never, { 'page': "page", 'disabled': "disabled", 'boundaryLinks': "boundaryLinks", 'directionLinks': "directionLinks", 'ellipses': "ellipses", 'maxSize': "maxSize", 'pageSize': "pageSize", 'rotate': "rotate", 'size': "size", 'collectionSize': "collectionSize" }, { 'pageChange': "pageChange" }, ["tplEllipsis", "tplFirst", "tplLast", "tplNext", "tplNumber", "tplPrevious"]>;
}

...
export declare class NgbTypeaheadWindow implements OnInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NgbTypeaheadWindow, "ngb-typeahead-window", ["ngbTypeaheadWindow"], { 'focusFirst': "focusFirst", 'formatter': "formatter", 'id': "id", 'results': "results", 'term': "term", 'resultTemplate': "resultTemplate" }, { 'selectEvent': "select", 'activeChangeEvent': "activeChange" }, never>;
}

...
export declare class NgbTimepicker implements ControlValueAccessor, OnChanges {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NgbTimepicker, "ngb-timepicker", never, { 'meridian': "meridian", 'spinners': "spinners", 'seconds': "seconds", 'hourStep': "hourStep", 'minuteStep': "minuteStep", 'secondStep': "secondStep", 'readonlyInputs': "readonlyInputs", 'size': "size" }, {}, never>;
}

...
export declare class NgbDatepickerNavigation {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NgbDatepickerNavigation, "ngb-datepicker-navigation", never, { 'months': "months", 'date': "date", 'disabled': "disabled", 'showSelect': "showSelect", 'prevDisabled': "prevDisabled", 'nextDisabled': "nextDisabled", 'selectBoxes': "selectBoxes" }, { 'navigate': "navigate", 'select': "select" }, never>;
}
